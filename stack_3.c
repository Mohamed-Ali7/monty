...
/**
 * rotl - Rotates the stack to the top which means that top element becomes
...
/**
 * rotr - Rotates the stack to the bottom which means that last element becomes
